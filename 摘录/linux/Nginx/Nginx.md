理由搪塞过去呢！今天就让我们一起告别这种尴尬，向“真正”的程序员迈进！！！

# Nginx 概述

![图片](assets/Nginx.assets/640-20210618160623825-4003583.png)
...
用一张图表示：
![图片](assets/Nginx.assets/640-20210618160623717.png)
...
用一张图清晰的展示它的层级结构：
![图片](assets/Nginx.assets/640-20210618160623717-4003583.png)
...
![图片](assets/Nginx.assets/640-20210618160623825.png)未命名文件 (1).png
...
![图片](assets/Nginx.assets/640-20210618160623695.png)image.png
...
![图片](assets/Nginx.assets/640-20210618160624058.png)image.png
...
![图片](assets/Nginx.assets/640-20210618160623835.png)未命名文件.png
...
![图片](assets/Nginx.assets/640-20210618160623859.png)
...
![图片](assets/Nginx.assets/640-20210618160623903.png)未命名文件 (2).png
...
![图片](assets/Nginx.assets/640-20210618160623882)image.png
...
![图片](assets/Nginx.assets/640-20210618160623894)image.png
...
![图片](assets/Nginx.assets/640-20210618160623961.png)
启用 `gzip` 同时需要客户端和服务端的支持，如果客户端支持 `gzip` 的解析，那么只要服务端能够返回 `gzip` 的文件就可以启用 `gzip` 了,我们可以通过 `Nginx` 的配置来让服务端支持 `gzip` 。下面的 `respone` 中 `content-encoding:gzip`，指服务端开启了 `gzip` 的压缩方式。
![图片](assets/Nginx.assets/640-20210618160624006.png)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/zPh0erYjkib1CxxiaXXtjSM4U1Y0r7AeZtjISwuYtV601flgG5sgMTvqKOM6hf0jbzwvgrB7iafwlBkVSvmPp6lVw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)未命名文件.png
...
![图片](assets/Nginx.assets/640-20210618160623966)