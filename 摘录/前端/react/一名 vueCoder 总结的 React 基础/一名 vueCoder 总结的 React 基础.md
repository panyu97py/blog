...
生命周期一定要好好理解，一定要动手写，看一下每种情况下，生命周期的执行结果。上述代码中在React-TypeScript 仓库中都有，可以 clone 下来跑跑看，或者直接访问俊劫学习系统 LifeCycle。还有些其他的生命周期，`componentDidCatch, UNSAFE_componentWillMount()`等等，简单了解下就行。
