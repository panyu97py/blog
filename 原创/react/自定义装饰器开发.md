...
不难发现`react-redux`是使用[`hoist-non-react-statics`](https://github.com/mridgway/hoist-non-react-statics)合并了静态方法。那我们来看看[`hoist-non-react-statics`](https://github.com/mridgway/hoist-non-react-statics)做了什么。
